...
public class NanoHTTPD
{
	 ...
	 */
	public Response serve( String uri, String method, Properties header, Properties parms, String postData, Properties files )
	{
	...
	private class HTTPSession implements Runnable
	{
		...
		public void run()
		{
			try
			{
				...
				// Ok, now do the serve()
				Response r = serve( uri, method, header, parms, postLine, files );
				if ( r == null )
